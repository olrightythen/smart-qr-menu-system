          ...
          <div className="grid md:grid-cols-2">
            <div className="p-8 md:p-12">
              ...
              <p className="text-muted-foreground mb-6">
                Join thousands of restaurants using Smart QR Menu System. Get
                started today with our 30-day free trial.
              </p>
              ...
              <div className="h-full flex items-center justify-center p-6">
                <div className="text-white max-w-xs">
                  ...
                  <p className="opacity-90 mb-6">
                    "Smart QR Menu System has revolutionized how we operate. Our
                    customers love it, and we've seen a significant increase in
                    order value."
                  </p>
                  <div>
