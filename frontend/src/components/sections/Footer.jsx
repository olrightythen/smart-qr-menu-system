...
import { QrCode, Mail, Phone, MapPin, Facebook, Instagram, Twitter } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Transforming restaurant menus into digital experiences. 
              Helping small businesses grow with smart technology.
            </p>
            <div className="space-y-3">
              <div className="flex items-center">
                <Mail className="h-5 w-5 text-muted-foreground mr-3" />
                <a href="mailto:info@smartqrmenu.com" className="hover:text-orange-500 transition-colors">
                  info@smartqrmenu.com
                </a>
              </div>
              <div className="flex items-center">
                <Phone className="h-5 w-5 text-muted-foreground mr-3" />
                <a href="tel:+9779876543210" className="hover:text-orange-500 transition-colors">
                  +977 9876543210
                </a>
              </div>
